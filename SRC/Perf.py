...
########################################################################
# PETRUS/SRC/Perf.py:
# This is the Perf Module of PETRUS tool
#
#  Project:        PETRUS
#  File:           Perf.py
...
def initPerfInfo(Conf, Services, Rcvr, RcvrInfo, Doy, PerfInfo, VpeHistInfo):
...
def updatePerfEpoch(Conf, Service, PosInfo, PerfInfoSer):
    ...
    # PosInfo: dict
    #          Dictionary containing position information per epoch
    # PerfInfoSer: dict
